...
<?php // Config
$codeSelect = $multiLanguage == 0 ? "code='".$_lang."_news'" : "code='vn_solution' or code='en_solution'";
$tableCategoryConfig = 'tbl_content_category';
$tableConfig         = 'tbl_content';
$actConfig           = 'solution_doc';
...
<?php if ($image_large!=''){ echo '<img border="0" src="../'.$image_large.'" width="100"><br><br>Hình (kích thước lớn)';}?>
				...
				<tr>
					<td width="15%" class="smallfont" align="right">Tên Giải pháp/tài liệu </td>
				...
				<tr>
					<td width="15%" class="smallfont" align="right">Nội dung sơ lược</td>
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">
