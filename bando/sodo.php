...
var map;
function initialize() {
      var myLatlng = new google.maps.LatLng(10.8172357, 106.63364409999997);
      var myOptions = {
    zoom: 16,
    center: myLatlng,
...
text= "<b style='color:#00F' " + 
         "style='text-align:center'>TNHH ĐIỆN TỬ VIỄN THÔNG SÀI GÒN" + 
     "</b>";
...
<body onLoad="initialize()">
    ...
    <table width="61%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="2%">&nbsp;</td>
        <td width="98%"><div align="center" class="style9"><strong>Cty TNHH ĐIỆN TỬ VIỄN THÔNG SÀI GÒN</strong><br />
ĐC: 86/6/3 Trần Thái Tông, P15, Q Tân Bình, TP Hồ Chí Minh<br />
Email: sales@saigonet.com.vn<br />
Điện thoại: 0989 921 827</div></td>
      </tr>
</table>
	<p>&nbsp;</p>
</body>
