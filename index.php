...
<script type="text/javascript">
    $(document).ready(function(){
        $('.style6').hover(function(){
            ...
            var zID = $('img',this).attr("alt");
            var classProCat = "procat_" + zID;
            var state=$("#"+classProCat).css("display");
            $("#"+classProCat).css("display","table");
        });
            ...
            <tr valign="top">
              <td width="193"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
				   ...
				   <tr>
                    <td class="style15">
                        <?php $code = $_lang == 'vn' ? 'vn_download' : 'en_download';
