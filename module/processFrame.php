<?php switch (addslashes($_REQUEST['frame'])){
    ...
    case "showcate"     	: include("module/showcate.php");break;	
    
    //----------------------Solution & docs-------------------------------------------------------------
    case "solution_doc"     : include("module/solution_doc.php");break;	
    case "solution_doc_detail"      : include("module/solotion_doc_detail.php");break;
