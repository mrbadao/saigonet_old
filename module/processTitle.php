<?php switch ($_REQUEST['frame']){
    ...
    case "showcate"        : $title = $_lang=="vn" ? "Danh mục sản phẩm" : "Product list"; break;
    case "solution_doc"    : $title = $_lang=="vn" ? "Giải pháp & Tài liệu" : "Solution & Docs"; break;
    case "solution_doc_detail"    : $title = $_lang=="vn" ? "Thông tin chi tiết" : "Detail"; break;
